...
export function defaultState() {
  ...
  // historyRemark: "이전호실점검내역/하자보수완료내역" 요약 화면 밑에 다는 비고(의견)
  // 란 — 맨 아래 "기타사항"(finalNote)과는 별개 필드다(박길일님 요청, 2026-09-15).
  return { info, items, open, custom, finalNote: '', historyRemark: '' };
}
...
export function loadState() {
  ...
  try {
    ...
    d.historyRemark = parsed.historyRemark || '';
    return d;
